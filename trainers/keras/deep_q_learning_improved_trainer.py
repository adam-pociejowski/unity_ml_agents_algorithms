...
class KerasDeepQLearningImprovedTrainer(KerasAgentTrainer):
    ...
    def __init__(self, brain, brain_name, input_num, output_num, agents_num, memory_size=5000, batch_size=32, layer_1_nodes=128, layer_2_nodes=128,
                 replace_target_iter=100, model_name='deep_q_learning_improved_keras', restore_model=False):
    ...
    def post_episode_actions(self, rewards, episode):
        ...
        self.target_network.save_weights(self.models_dir + "/target_network.h5")
    ...
    def _train(self):
        ...
        q_target = self.target_network.predict(new_observations_sample, batch_size=self.batch_size)
    ...
    def _restore_model(self):
        ...
        self.target_network.load_weights(self.models_dir + "/target_network.h5")
